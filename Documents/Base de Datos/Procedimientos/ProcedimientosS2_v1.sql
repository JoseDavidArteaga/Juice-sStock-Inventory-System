...
DECLARE
    v_bandera NUMBER;
BEGIN
    eliminar_producto_proc('Jugo de Naranja', v_bandera);
    DBMS_OUTPUT.PUT_LINE('Bandera: ' || v_bandera);
END;

DECLARE
    v_bandera NUMBER;
BEGIN
    agregar_producto_proc('Jugo de Naranja', 'JARRA DE JUGO', 5500, 'Zumo Vital', v_bandera);
    DBMS_OUTPUT.PUT_LINE('Bandera: ' || v_bandera);
END;
