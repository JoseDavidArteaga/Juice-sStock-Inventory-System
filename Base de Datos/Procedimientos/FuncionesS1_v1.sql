...
DROP FUNCTION agregar_cantidad_producto;
DROP FUNCTION eliminar_cantidad_producto;
...
así no se modifique, debe ingresarse el "nuevo" id.  Retorna un entero
...
END;
--------------------------------------------------------------------------------
/*eliminar_producto: esta ya se intuye
...
¿La cantidad del producto cambió?
SI -> 1
NO -> 0 */
CREATE OR REPLACE FUNCTION agregar_cantidad_producto(
    p_id_prod PRODUCTO.ID_PROD%TYPE,
...
BEGIN
    ...
    ELSE
        RETURN 0; 
    END IF;
END agregar_cantidad_producto;
--------------------------------------------------------------------------------
/*eliminar_cantidad_producto: 
¿La cantidad del producto se elimino?
SI -> 1
NO -> 0 */
CREATE OR REPLACE FUNCTION eliminar_cantidad_producto(
    p_id_prod PRODUCTO.ID_PROD%TYPE,
...
BEGIN
    ...
    ELSE
        RETURN 0;
    END IF;
END eliminar_cantidad_producto;
--------------------------------------------------------------------------------
